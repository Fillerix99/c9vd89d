...
prompt.start();
console.log("Otohits:");
 prompt.get(['usr',], function (err, result) {
    if (err) { return onErr(err); }
    
var i = result.usr, o = ''; for (var j = 0; j < i.length; j++) o += (j === 0 ? '' : ', ') + 'letter' + (j+1) + ' = ' + i[j]; console.log(o);
...
if (i[23]){
   robot.typeString(i[23]);
}
if (i[24]){
   robot.typeString(i[24]);
}
if (i[25]){
   robot.typeString(i[25]);
}
if (i[26]){
   robot.typeString(i[26]);
}
if (i[27]){
   robot.typeString(i[27]);
}
if (i[28]){
   robot.typeString(i[28]);
}
if (i[29]){
   robot.typeString(i[29]);
}
if (i[30]){
   robot.typeString(i[30]);
}
if (i[31]){
   robot.typeString(i[31]);
}
if (i[32]){
   robot.typeString(i[32]);
}
if (i[33]){
   robot.typeString(i[33]);
}
if (i[34]){
   robot.typeString(i[34]);
}
if (i[35]){
   robot.typeString(i[35]);
}
if (i[36]){
